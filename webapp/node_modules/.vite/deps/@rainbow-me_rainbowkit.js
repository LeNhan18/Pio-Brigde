...
import {
  ...
  useSignMessage,
  useSwitchChain
} from "./chunk-5URU5NJQ.js";
import {
  createConfig,
  createConnector,
  extractRpcUrls,
  injected
} from "./chunk-4MIM5BAT.js";
import "./chunk-KO32JKQ2.js";
import {
  ChainNotConfiguredError,
  ProviderNotFoundError
} from "./chunk-QAMSO46Q.js";
import {
  http,
  withRetry,
  withTimeout
} from "./chunk-4U3YTXJ5.js";
import "./chunk-COP7IQQM.js";
import "./chunk-2GCCONF6.js";
import {
    ...
    async getProvider() {
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-NES3ZXED.js");
...
function version3(parameters) {
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-D24EKHSG.js");
          if (typeof SDK !== "function" && typeof SDK.default === "function")
            return SDK.default;
          return SDK;
        })();
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-3BCD5NDI.js");
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-6K3Y7VKJ.js");
